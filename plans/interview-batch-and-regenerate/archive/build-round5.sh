#!/bin/bash
set -euo pipefail
cd /Users/andersonedmond/SyntheticResponderLab-interview-batch-and-regenerate
...
NAME=interview-batch-and-regenerate
PLAN=plans/$NAME
...
for round in 1 2 3; do
  ...
  $CODEX exec --cd /Users/andersonedmond/SyntheticResponderLab-interview-batch-and-regenerate --sandbox workspace-write --skip-git-repo-check -m gpt-6-astra \
    "$brief

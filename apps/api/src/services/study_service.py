...
def bootstrap_neo_demo_study(
    ...
    _save_section(
        ...
        study,
        "audience",
        validate_audience(deepcopy(NEO_BOOTSTRAP_AUDIENCE), settings.legacy_app_root),
    )
    _save_section(
        session,
        study,
        "product",
        validate_product(deepcopy(NEO_BOOTSTRAP_PRODUCT), settings.legacy_app_root),
    )
    validated_market = validate_market(
        deepcopy(NEO_BOOTSTRAP_MARKET), settings.legacy_app_root
    )
    ...
    _save_section(
        ...
        study,
        "experiment",
        validate_experiment(deepcopy(NEO_BOOTSTRAP_EXPERIMENT), settings.legacy_app_root),
    )
